...
- **Arcanum Prompt Injection Taxonomy** — the PIT alias layer
  (`norn/domain/pit_map.json`, generated by `scripts/import_pit.py`) is based
  on the *Arcanum Prompt Injection Taxonomy* by Jason Haddix, Arcanum
